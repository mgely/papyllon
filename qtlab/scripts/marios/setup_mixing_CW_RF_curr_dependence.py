...
bias_start_cav = 7.855e9
bias_stop_cav = 7.935e9
bias_f_points =801
bias_ifbw = 100
bias_pow=-30
bias_aver_cav=1
...
##
###setup CW scan
pna.w("CALC2:PAR:DEF:EXT 'CH2_CW_S1', 'B,1'")
pna.w("DISP:WIND2:TRACE1:FEED 'CH2_CW_S1'")
pna.w("CALC2:PAR:SEL 'CH2_CW_S1'")
pna.w("CALC2:FORM MLOG")

pna.w("SENS2:SWE:TYPE CW")
pna.w("SENS2:FREQ:CW 7e9")
