...
data.copy_file('7_S21_twotone__spt_XYZ_mag_low.py')
...
timing.start()
pna_set_2tone_probewer(0)

#set cavity power

pna.w("SOUR2:POW1 %s" %(10))    
...
#    pna.w("SOUR2:POW1 %s" %(Z))
    ...
    for Y in Y_list:
        ...
        #set magnet
        ramp_source_curr(Y*1e-3,10e-3,1e-6)
