...
#setup the PNA by hand
pna.w("DISP:WIND1:STATE ON")
pna.w("CALC1:PAR:DEF:EXT '1', 'S21'")
pna.w("DISP:WIND1:TRACE1:FEED '1'")
pna.set_start_frequency(start_freq)
pna.set_stop_frequency(stop_freq)
pna.set_measurement_format('MLIN')

#pna.setup_DAC_scan(start_frequency=start_freq,stop_frequency=stop_freq,measurement_format = 'MLIN')
pna.set_power(power)
...
pna.w("CONT:AUX:OUTP1:VOLT 10")

#now start copying all the channels...
pna.w("SYST:MACR:COPY:CHAN1 2")
pna.w("CALC2:PAR:SEL 'CH2_S11_2'")
pna.w("CALC2:PAR:MOD:EXT 'S21'")
pna.w("CALC2:FORM MLIN")
pna.w("CONT:AUX:OUTP1:VOLT -10")
#pna.w("DISP:WIND2:TRAC:FEED 'CH2_S11_2'")

#pna.w("CALC2:PAR:DEL:ALL")
#pna.w("CALC2:PAR:DEF:EXT '2', 'S21'")

#pna.w("DISP:WIND1:TRACE1:FEED '1'")

#pna.w("DISP:WIND2:TRACE2:FEED '2'")
pna.w("INIT:CONT OFF")
