...
if 'source' not in instlist:
    source = qt.instruments.create('source', 'key_sight_source_B2961A', address='TCPIP::192.168.1.56::INSTR')
...
source.set_current_protection(1e-9)
source.protection_state(True)
