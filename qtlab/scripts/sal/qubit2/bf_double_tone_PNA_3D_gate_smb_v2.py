...
#Set up data
filename = 'bf_double_tone_PNA_3D_gate_smb_v2'
...
data.copy_file('bf_double_tone_PNA_3D_gate_smb_v2.py')
...
prev_time=tstart
now_time=0
exp_number = len(probe_list)*averages*len(gatelist)

adwin.set_DAC_2(maglist[0])
...
for gate in gate_list:
    ...
    ##        qt.msleep(sweeptime)
        ...
        data.new_block()
        spyview_process(data,start_freq,stop_freq,stop_probe, start_probe,gate,newoutermostblockval=new_outermostblockval_flag)
