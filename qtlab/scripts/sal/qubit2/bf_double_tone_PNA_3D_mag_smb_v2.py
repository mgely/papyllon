...
maglist=np.linspace(float(I_bias_start),float(I_bias_stop),magpoints)
...
#Set up data
filename = 'bf_double_tone_PNA_3D_mag_smb_v2'
...
data.copy_file('bf_double_tone_PNA_3D_mag_smb_v2.py')
