...
base_path = 'D:\\data\\Sal\\LETO11V_omit\\'
...
pna_set_2tone_probe_frequency(start_frequency=X_start+f_cav,stop_frequency=X_stop+f_cav, points=X_points,ifbw=ifbw_probe)
pna.w("SENS2:AVER:COUN %s" % (aver_probe))

timing.start()
#pna_set_2tone_probe_power(-7.5)
#set omit probe tone inside cavity
pna.w("SOUR2:POW1 %s" %(14))
for Z in Z_list:
