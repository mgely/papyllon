...
mvar_1 = 'FSV'  #Use intrument to read (keithley1,PNA_single,Adwin,FSV)
mmul_1 = 1       #multiplier for the read value

#var options are 'Vb'[V],'vg_F,hemt_F'[MHz],''hemt_Pow',vg_Pow'[dBm](Lo),'Vg'[V],'none'
...
x_sleep = 0.1 #wait before taking the x-sweep 20ms is perfect for Vb
...
data.create_file(name=filename, datadirs='D:\\data\\Ben\\CNT-Ringdown\\calibration2')
data.copy_file('generic_sweeper_v2.py')
