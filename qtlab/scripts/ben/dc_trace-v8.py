...
med.set_user('Ben')
current_gain = 10**7 #1G#1M V/A (setting on the measurement unit)
voltage_gain = 1
...
y_start = -0.0003-0.0003#0.787 -0.017 #0.759
y_stop =  0.0003-0.0003#0.787 +0.017 #0.797
y_step =  0.00002
if yvarname == 'nothing':
    y_start= 0
    y_stop=  0.01
