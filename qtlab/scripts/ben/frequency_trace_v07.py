...
#set frequencies
RF_start_fixed= 267 #prev. 279-30 #MHz #res 1 at 136Mhz 2 at 306MHz
RF_stop_fixed= 290 #prev. 279+30 #MHz
RF_step=0.02#0.4 #MHz
...
if (readoutmode == 'HFlockin') | (readoutmode == 'oscilloscope') | (readoutmode == 'HFoscil'):
    ...
    filterorder = 3 #18db/oct #8 use 48dB/Oct
