...
med.set_user('Ben')
current_gain = 10**7 #10M V/A (setting on the measurement unit)
voltage_gain = 1
...
x_start =298#302.5 - 0.5
x_stop  =304#302.5 + 0.8
x_step  =0.001# 0.025
if xvarname == 'nothing':
    x_stop=0
    x_start=0.1
...
y_start =-10#0.764-0.01# 0.768#0.787 -0.017 #0.759
y_stop  =-30#0.764+0.01#  0.785#0.787 +0.017 #0.797
y_step  =1#0.002
if yvarname == 'nothing':
    y_start= 0
    Noysteps=40
