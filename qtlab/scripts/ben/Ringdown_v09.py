...
#set frequencies
RF_start_fixed=301.4#-0.5 #302.45-0.2 #302.4#
RF_stop_fixed =301.7#+0.5 #302.45+0.2 #303.3#
...
y_start = 0.4-0.012# 0.389#0.66#0.774-0.05#0.787 - 0.2#0.787 - 0.017
y_stop  = 0.4+0.012#0.414#0.91#0.774+0.05#0.787 + 0.1#0.787 + 0.017
y_step  = 0.006#0.02
if yvarname == 'nothing':
    y_start=1
    Noysteps=1
...
averages     = 10000 # simply set the number of averages
