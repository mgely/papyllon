...
x_start= -4
x_stop = 4
x_resolution = 0.01 #min: 0.02 & -13dBm 
...
#sweep('FF_pow',0)
#SMB2 is connected to Hemt 
smb2.set_RF_power(10)
smb2.set_RF_frequency(120)
smb2.set_RF_state(0) #activate 1
#SMB1 is connected to Vb AC in
smb1.set_RF_power(7)
smb1.set_RF_frequency(7)
