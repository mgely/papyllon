...
#set frequencies
RF_start_fixed=299#-0.5 #302.45-0.2 #302.4#
RF_stop_fixed =300.3#+0.5 #302.45+0.2 #303.3#
RF_step=0.001#0.0125#0.4 #MHz
...
y_start = -35#0.66#0.774-0.05#0.787 - 0.2#0.787 - 0.017
y_stop  = -50#0.91#0.774+0.05#0.787 + 0.1#0.787 + 0.017
y_step  = 2#0.02
if yvarname == 'nothing':
    y_start=1
    Noysteps=1
...
scale        = 11000 # scale of the lockin output for X,Y,R,Theta
settlingtime = 0.1 #10*timeconstant #settlingtime
averages     = 20000 # simply set the number of averages
