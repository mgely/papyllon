...
yvalsleep = 0.01 # time to wait after setting the value before doing x sweep
...
x_start =   293 #295.7 -(1.92*2)
x_stop =    296+3 #295.7 +(1.92)
x_step =      0.03
if xvarname == 'nothing':
    x_stop=0
    x_start=0.1
...
y_start = 0.787 - 0.2 #0.787 -0.017  
y_stop =  0.787 + 0.1 #0.787 +0.017
y_step =  0.008 #0.005
if yvarname == 'nothing':
    y_start= 0
    y_stop=  0.01
