...
med.set_user('Ben')
current_gain = 10**6 #1G#1M V/A (setting on the measurement unit)
voltage_gain = 1
...
xvalsleep = 0.000 # time to wait between set values and measurement
...
#set y variable
yvarname = 'vbias' # 'vgate' or 'RF_power' or 'RF_frequency' or 'f_LO' or 'vdd' or 'tc' vbias
