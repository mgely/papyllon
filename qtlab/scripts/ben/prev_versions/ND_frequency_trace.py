...
if highfrequency:
    if 'HFlockin' not in instlist:
        HFlockin = qt.instruments.create('HFlockin', 'ZI_HF_2LI-v2',host='localhost',port=8005,reset=False)
...
#set frequencies
RF_start_fixed=121 #MHz
RF_stop_fixed=130 #MHz
RF_step=0.1#0.4 #MHz
