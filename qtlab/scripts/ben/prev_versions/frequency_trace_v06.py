...
set_fixed_values(yvarname,
                 ...
                 logtimeconstant = log10(0.020),#20ms timeconstant #-3, #-6 has maximised noise value..
                 Vdd_fixed = 0.4,
                 Vattplus= 0,
                 Vattctrl= 0)

#settlingtime = 1*timeconstant #overwrite settlingtime (instead of *10 try *1)
'''
...
data.create_file()
data.copy_file('frequency_trace_v06.py')
