...
#set y variable
yvarname = 'RF_power' # 'vgate' or 'RF_power' or 'RF_frequency' or 'f_LO' or 'vdd' or 'tc' vbias
...
if (xvarname != 'RF_power') & (yvarname != 'RF_power') & (zvarname != 'RF_power'):
    RF_power_fixed = -25 #dbm
    smbgate.set_RF_power(RF_power_fixed)
    print '+++ RF_power: %sV +++' % RF_power_fixed
...
if (xvarname != 'RF_frequency') & (yvarname != 'RF_frequency') & (zvarname != 'RF_frequency'):
    ...
    print '+++ RF_power: %sV +++' % RF_freq_fixed
...
data.create_file()
data.copy_file('dc_trace-experimental-v3.py')
