...
#set frequencies
RF_start_fixed=298.5#1.5#302.05#prev. 279-30 #MHz #res 1 at 136Mhz 2 at 306MHz
RF_stop_fixed =300.75#3.5#302.7 #prev. 279+30 #MHz
RF_step=0.01#0.002#0.4 #MHz
...
settlingtime = 0.001+1*timeconstant #overwrite settlingtime (instead of *10 try *1)
