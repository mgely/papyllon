...
RF_stop_fixed =302.8#+0.5 #302.45+0.2 #303.3#
...
y_start = -2.28-0.012# 0.389#0.66#0.774-0.05#0.787 - 0.2#0.787 - 0.017
y_stop  = -2.28+0.012#0.414#0.91#0.774+0.05#0.787 + 0.1#0.787 + 0.017
y_step  = 0.006#0.02
if yvarname == 'nothing':
    y_start=1
    Noysteps=1
