...
filename = 'S21_powerSMB2_Sweep_UPDN_custom'
...
data.copy_file('bf-PNA_trace_powerSMB2_SweepUPDN_custom.py')
...
#T 13 mK
# Gate = 3.12 / 4 V
# Cavity2 at carrier optimum number 5931.35 with dBm - 10dB(dir coup)-6 (att)-10 dir coup(-37 on device)
