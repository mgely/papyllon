...
data.copy_file('bf_split_power.py')
...
## Cavity settings
hang_st=5930.124 + 40.764 - 0.100  #MHz
hang_sp=5930.124 + 40.764 + 0.100  #MHz
hang_pt=51
hang_pow_start=30  # dBm
hang_pow_stop=14
hang_pow_pt=17
...
pow_list=np.linspace(hang_pow_start,hang_pow_stop,hang_pow_pt)
...
for pw in hang_pow_list:
    ...
    for hf in hang_f_list:
        ...
        data.add_data_point(pw_dummy,hf_dummy,f_list,trace[0],trace[1],trace2[0],trace2[1])
        data.new_block()
