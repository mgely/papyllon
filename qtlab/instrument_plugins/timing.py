...
class timing(Instrument):

    def __init__(self, name, address=None, reset=False):
        Instrument.__init__(self, name, tags=['measure', 'med'])

        # minimum
        self.add_parameter('X_points', type=types.IntType,
                flags=Instrument.FLAG_GETSET)

        self.add_parameter('Y_points', type=types.IntType,
                flags=Instrument.FLAG_GETSET)

        self.add_parameter('Z_points', type=types.IntType,
                flags=Instrument.FLAG_GETSET)

        self.add_parameter('Y_name', type=types.StringType,
                flags=Instrument.FLAG_GETSET)

        self.add_parameter('Z_name', type=types.StringType,
                flags=Instrument.FLAG_GETSET)
