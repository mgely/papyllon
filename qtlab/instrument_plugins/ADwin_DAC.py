...
class ADwin_DAC(Instrument):
    ...
    def __init__(self, name, address):
        ...
        self.add_function('ramp_DAC_1')
        self.add_function('ramp_DAC_2')
        self.add_function('ramp_DAC_3')
        self.add_function('ramp_DAC_4')
...
# --------------------------------------
    ...
    def ramp_DAC_1(self, value,desired_rampspeed=.1):
