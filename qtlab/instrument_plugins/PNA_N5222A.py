...
class PNA_N5221A(Instrument):
    '''
    This is a qtlab driver for the Agilent PNA_N5222A VNA 4port model.
    ...
    def __init__(self, name, address):
        ...
        logging.info('Initializing instrument Agilent PNA_N5222A')
...
# --------------------------------------
    ...
    def setup_2tone_spectroscopy(self, cw_freq=3e9, start_freq=1e9, stop_freq=10e9, sweep_time=10):
        ...
        to the required B, 1 position (measuring absolute power at port 2, while sending a stimulus via port 1) with the commands
        pna.w("CALC1:PAR:SEL '1'")
        pna.w("CALC1:PAR:MOD:EXT 'B,1'")
        '''
        ...
        self._visainstrument.write("CALC1:PAR:MOD:EXT 'B,1'")
