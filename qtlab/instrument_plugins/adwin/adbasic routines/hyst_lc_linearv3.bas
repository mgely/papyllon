	...
	CASE 1	'measure
		...
		SELECTCASE measureflag
			...
			CASE 1 'read ADC 
				...
				ENDIF
				IF ( adcreadout2 < 32768 ) THEN
					adcreadout2 = 65536-adcreadout2
				ENDIF
