def spyview_process_3D(data=0,minval=0,maxval=0,minblockval=0,maxblockval=0,outermostblockval=0,reset=False,_outermostblockvals=[],newoutermostblockval=False):
    '''
